...
//		cameraLocations.add(new SampleGeographicLocation("Niagara Falls",new double[]{110.12,60.11,43.08,-79.07,1530}));
	}
	...
	public SampleGeographicLocation getNextLocation() {
		...
		curLoc %= cameraLocations.size(); // same behavior as below but no branching
